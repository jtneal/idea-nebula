...
export class CategoryManagerComponent {
  ...
  @Output() addCategoryEvent = new EventEmitter<{title: string, color: string}>();
  ...
  deleteCategory(id: string) {
    if (confirm('Are you sure you want to delete this category? Ideas in this category will be uncategorized.')) {
